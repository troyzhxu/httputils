...
### 当前文档版本[2.1.1]
#### [查阅[2.1.0]点我跳转](https://gitee.com/ejlchina-zhxu/httputils/blob/master/README-2.1.0.md) | [查阅[2.0.0]点我跳转](https://gitee.com/ejlchina-zhxu/httputils/blob/master/README-2.0.0.md) | [查阅[1.x.x]点我跳转](https://gitee.com/ejlchina-zhxu/httputils/blob/1.x/README.md)
...
　　类`HttpUtils`本是 1.x 版本里的最重要的核心类，由于在 2.x 版本里抽象出了`HTTP`接口，使得它的重要性已不如往昔。但合理的使用它，仍然可以带来不少便捷，特别是在没有IOC容器的环境里，比如在Android开发和一些工具项目的开发中。
